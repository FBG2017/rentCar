...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "priv.thinkam.rent.common.webservice.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "priv.thinkam.rent.common.webservice.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns priv.thinkam.rent.common.webservice.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "priv.thinkam.rent.common.webservice.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "priv.thinkam.rent.common.webservice.GetDatabaseInfoResponse")
