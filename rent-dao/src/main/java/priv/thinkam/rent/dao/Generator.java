package priv.thinkam.rent.dao;


import priv.thinkam.rent.common.util.MybatisGeneratorUtil;
import priv.thinkam.rent.common.util.PropertiesFileUtil;
...
public class Generator {
	...
	private static String PACKAGE_NAME = "priv.thinkam.rent";
	...
	public static void main(String[] args) throws Exception {
		...
		PropertiesFileUtil instance = PropertiesFileUtil.getInstance("generator");
